...
local function OpenDoorMenu(door)
    ...
    hint:Dock(TOP)
    hint:SetText("[F2] Open menu    [F1] Toggle third-person")
...
hook.Add("HUDPaint", "DBS.Doors.ContextPrompt", function()
    ...
    draw.SimpleText("F2: Property menu   |   F1: Third person", "DBS_UI_Body", x + 24, y + 52, Color(220, 220, 220), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end)
