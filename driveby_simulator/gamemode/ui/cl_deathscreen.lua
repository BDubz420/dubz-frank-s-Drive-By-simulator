...
hook.Add("HUDPaint", "DBS.DeathScreen", function()
    ...
    local left = math.max(0, respawnAt - CurTime())
    draw.SimpleText("Respawning in " .. string.format("%.1f", left) .. "s", "DBS_DEATH_Body", ScrW() * 0.5, ScrH() * 0.54, Color(190, 170, 170), TEXT_ALIGN_CENTER)
end)
